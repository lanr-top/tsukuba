...
st1 = threading.Thread(target=stepper_worker, args=(myStepper1, steps, dir, stepstyles[3],))
st1.start()
print("over1")
# st2 = threading.Thread(target=stepper_worker, args=(myStepper2, steps, dir, stepstyles[3],))
# st2.start()
# print("over2")
	# if not st2.isAlive():
	# 	print("Stepper 2"),
